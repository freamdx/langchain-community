...
class AnalyticDBMySQL(VectorStore):
    ...
    def _build_query_sql(
        ...
        q_embed_str = ",".join(map(str, q_emb))
        q_embed_arr = f"[{q_embed_str}]"
        all_params = [q_embed_arr] + params + [top_k]
        ...
        SELECT
            ...
            l2_distance({self.config.column_map["embedding"]},%s) as dist,
